    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Product Minecraft Hosting</a>
              </li>
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Product Bot Hosting</a>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <a href="https://whatsapp.com/channel/0029VaMAfuOEwEk5VBtH4E3Q" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">WhatsApp</a>
              </li>
              <li className="mb-2">
                <a href="#0" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Discord</a>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-sm text-gray-600 mb-4">Contact us to order products or ask questions.</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; Craftee. All rights reserved.</div>
